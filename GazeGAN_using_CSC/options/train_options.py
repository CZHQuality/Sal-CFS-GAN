...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--niter', type=int, default=1 + 9 + 10 + 5 + 5, help='# of iter at starting learning rate')
        ...
        self.parser.add_argument('--lambda_CC', type=float, default=10.0, help='weight for CC loss')  
