...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpointsMy/pretrained_model_epoch8', help='models are saved here')       # finetune on SALICON val dataset
        # self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpointsMy/pretrained_model_epoch_d_conv_lstm', help='models are saved here') # finetune on MIT1003
        ...
        # self.parser.add_argument('--loadSize', type=int, default=80, help='scale images to this size') # My input size for SALICON model, width of the image
        ...
        # self.parser.add_argument('--dataroot', type=str, default='/home/che-z/docker-czh/datasets/CAT2000/MyCAT/') 
        self.parser.add_argument('--dataroot', type=str, default='/home/che-z/docker-czh/datasets/MIT1003_scaled/')
        # self.parser.add_argument('--dataroot', type=str, default='/home/che-z/docker-czh/datasets/MIT300_scaled/')
        # self.parser.add_argument('--dataroot', type=str, default='/home/che-z/docker-czh/datasets/Saliency4ASD_test_subset/') 
