# We add our CC loss into this script
### Copyright (C) 2017 NVIDIA Corporation. All rights reserved. 
### Licensed under the CC BY-NC-SA 4.0 license (https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode).
# We change the VGG loss into a "conditional perceptual loss" in this code
...
class Pix2PixHDModel(BaseModel):
    ...
    # def init_loss_filter(self, use_gan_feat_loss, use_vgg_loss, use_cc_loss, use_kl_loss):
    def init_loss_filter(self, use_gan_feat_loss, use_vgg_loss, use_cc_loss, use_kl_loss, use_nss_loss):
    ...
    def forward(self, label, inst, image, fixpts, feat, infer=False): # add the fixation maps as input
        # Encode Inputs
    ...
    def tensor2saveimg(self, input, svname): # for tensor, visualization by saving as image, make sure that the input is a 4-dims tensor, and svname is a string
