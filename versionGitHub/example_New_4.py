...
iters = 2000 + 2 # taken from pix2pix paper 5.2
...
A = np.load(Dataset_Root_Path + '2_dataset_y_SALICON_train.npy') # original images XXXXXXXXXXXXXXXXXXXX 
B = np.load(Dataset_Root_Path + '2_dataset_x_SALICON_train.npy') # saliency maps XXXXXXXXXXXXXXX
C = np.load(Dataset_Root_Path + '2_dataset_Pts_SALICON_train.npy') # fixation points maps XXXXXXXXXXXXXX
