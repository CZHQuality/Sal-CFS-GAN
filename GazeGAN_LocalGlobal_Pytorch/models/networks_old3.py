# We add the saliency losses in this script, which are CC, NSS, KL and L1
...
class GlobalUNet(nn.Module):
    ...
    def forward(self, input):
        ...
        # self.activation_2 = nn.LeakyReLU(0.2)      

        # model = [nn.ReflectionPad2d(3), nn.Conv2d(input_nc, ngf, kernel_size=4, padding=0), norm_layer(ngf), activation_2]
